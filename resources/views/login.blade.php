  ...
  <body class="login-page access-page has-full-screen-bg">
    <div class="layout-canvas">
      <div class="layout-container">
        ...
        <!-- Login Section -->
        <section class="login-section section-access section">
          <div class="container">
            <div class="row">
                  ...
                  <div class="row">
                    <div class="form-container col-xs-12 col-md-5">
                      <form class="login-form" method="POST" action="{{ route('login') }}">
                        ...
                        <!-- .checkbox -->
                        <p class="lead">Don't have a Marvel account yet?
                          <br />
                          <a class="signup-link" href="{{route('signup')}}">Create account now</a>
                        </p>
                      </form>
                    </div>
                    <!-- .form-container -->
                      ...
                      <ul class="list-unstyled social-login">
                        <li>
                          <button class="twitter-btn btn" type="button">
                            <i class="fa fa-twitter"></i>Log in with Twitter</button>
                        </li>
                        <li>
                          <button class="facebook-btn btn" type="button">
                            <i class="fa fa-facebook"></i>Log in with Facebook</button>
                        </li>
                        <li>
                          <button class="github-btn btn" type="button">
                            <i class="fa fa-github-alt"></i>Log in with Github</button>
                        </li>
                        <li>
                          <button class="google-btn btn" type="button">
                            <i class="fa fa-google-plus"></i>Log in with Google</button>
                        </li>
                      </ul>
                    </div>
                    <!-- .social-btns -->
